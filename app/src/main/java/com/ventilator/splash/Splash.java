...
import com.ventilator.main.MyNavigationActivity;
...
public class Splash extends SplashActivity {
    ...
    public void setShowContent() {
        ...
        setAppName("CFJD11W矿用通风机无线多参数测试仪");
    ...
    public void WriteToSD(Context context) {
        ...
        new Thread() {
            ...
            public void run() {
                ...
                String path = sd.getPath() + "/CFJD11W矿用通风机无线多参数测试仪/.报告模板";
                String path2 = sd.getPath() + "/CFJD11W矿用通风机无线多参数测试仪/测试报告";
                String path3 = sd.getPath() + "/CFJD11W矿用通风机无线多参数测试仪/.通风机性能曲线图";
                String path4 = sd.getPath() + "/CFJD11W矿用通风机无线多参数测试仪/软件";
        ...
        String filePath1;
        filePath1 = Environment.getExternalStorageDirectory() + "/CFJD11W矿用通风机无线多参数测试仪/软件";
