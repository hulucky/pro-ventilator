...
import com.ventilator.data.DataManager;
import com.ventilator.param.ParamSetActivity;
import com.ventilator.pdf.StandardListActivity;
import com.ventilator.report.ReportActivity;
...
//        Toast.makeText(getApplicationContext(),"测试按钮",Toast.LENGTH_SHORT).show();
    ...
    public void onSpecificationClickListenter() {
        ...
        Intent intent = new Intent(MyNavigationActivity.this, com.ventilator.pdf.PdfguideActivity.class);
